...
public class ProjectHandler {
  ...
  public ProjectHandler(List<Project> projectList, MemberHandler memberHandler) {
    ...
    project.setStartDate(Date.valueOf("2021-07-31"));
    project.setEndDate(Date.valueOf("2021-10-15"));
    ...
    project.setContent("내용!!!");
    project.setStartDate(Date.valueOf("2021-02-2"));
    project.setEndDate(Date.valueOf("2021-3-3"));
  ...
  public void add() {
    ...
    System.out.println("프로젝트를 저장하였습니다.");
  }
