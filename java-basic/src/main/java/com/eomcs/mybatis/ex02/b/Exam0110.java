...
public class Exam0110 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // => 컬럼 이름과 일치하는 '프로퍼티'가 없다면,
    //    컬럼 이름과 일치하는 '필드'를 찾는다.
    // => 컬럼 이름과 일치하는 세터나 필드가 없다면
    //    해당 컬럼의 값이 자바 객체에 저장되지 못한다.
    // => 컬럼과 일치하는 프로퍼티나 필드가 한 개라도 없다면
    //    
...
//   no, title, content, registeredDate, viewCount 가 있다.
//   - 이 프로퍼티나 필드 중에서 컬럼 이름고 일치하는 프로퍼티나 필드는 title 뿐이다.
...
// => 그러면 어떻게 하자는 것인가?
//    - select 할 때 컬럼의 별명을 자바 프로퍼티(또는 필) 이름과 같게 하라!
