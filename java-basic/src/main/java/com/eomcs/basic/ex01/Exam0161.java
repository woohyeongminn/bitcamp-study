...
public class Exam0161 {
  ...
  public static void main(String[] args) {
    ...
    // 배열의 클래스 정보
    Date[] woo1 = new Date[10];
    classInfo = woo1.getClass();
    ...
    //    int i = 100;
    //    classInfo = i.getClass();    // primitive 타입은 Object의 서브 클래스가 아니다.
    ...
    System.out.println(new long[10].getClass().getName()); //[J  > 이미 레퍼런스에서 L을 사용함...
    System.out.println(new char[10].getClass().getName()); //[C
    System.out.println(new boolean[10].getClass().getName()); //[Z > 이미 byte에서 사용...
  }
}
