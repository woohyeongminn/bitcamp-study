...
ALTER TABLE pms_mylist
  ADD CONSTRAINT PK_pms_mylist -- 좋아요 기본키
    PRIMARY KEY (
      member_no, -- 회원번호
      board_no   -- 게시글번호
    );
...
ALTER TABLE pms_like
  ADD CONSTRAINT PK_pms_like -- 내관심게시글 기본키
    PRIMARY KEY (
      member_no, -- 회원번호
      board_no   -- 게시글번호
    );
...
-- 좋아요
ALTER TABLE pms_mylist
  ADD CONSTRAINT FK_pms_member_TO_pms_mylist -- 회원 -> 좋아요
    FOREIGN KEY (
      member_no -- 회원번호
    )
    REFERENCES pms_member ( -- 회원
...
-- 좋아요
ALTER TABLE pms_mylist
  ADD CONSTRAINT FK_pms_board_TO_pms_mylist -- 게시판 -> 좋아요
    FOREIGN KEY (
      board_no -- 게시글번호
    )
...
-- 내관심게시글
ALTER TABLE pms_like
  ADD CONSTRAINT FK_pms_member_TO_pms_like -- 회원 -> 내관심게시글
    FOREIGN KEY (
      member_no -- 회원번호
    )
    REFERENCES pms_member ( -- 회원
...
-- 내관심게시글
ALTER TABLE pms_like
  ADD CONSTRAINT FK_pms_board_TO_pms_like -- 게시판 -> 내관심게시글
    FOREIGN KEY (
      board_no -- 게시글번호
    )
    REFERENCES pms_board ( -- 게시판
